...
tasks.register<GenerateTask>("openApiGenerateWORKFLOWHUB") {
  ...
  generatorName.set("java")
  remoteInputSpec.set("https://raw.githubusercontent.com/pagopa/p4pa-workflow-hub/refs/heads/fix-openapi/openapi/p4pa-workflow-hub.openapi.yaml") //TODO: RESTORE
  outputDir.set("$projectDir/build/generated")
