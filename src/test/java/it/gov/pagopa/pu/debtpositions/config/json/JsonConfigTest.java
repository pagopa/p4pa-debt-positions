...
class JsonConfigTest {
  ...
  void testJsonUnknownPropertiesNotAllowed() throws JsonProcessingException {
    ...
    SampleDTO resultIgnoringUnknown = j3JsonMapper.readValue(invalidJson, SampleDTO.class);
    Assertions.assertEquals(new SampleDTO(), resultIgnoringUnknown);

    resultIgnoringUnknown = j2ObjectMapper.readValue(invalidJson, SampleDTO.class);
    Assertions.assertEquals(new SampleDTO(), resultIgnoringUnknown);
  }
}
