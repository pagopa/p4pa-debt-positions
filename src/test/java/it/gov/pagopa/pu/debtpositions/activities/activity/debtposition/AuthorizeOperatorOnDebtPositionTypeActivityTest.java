...
import it.gov.pagopa.pu.debtpositions.activities.activity.AuthorizeOperatorOnDebtPositionTypeActivity;
import it.gov.pagopa.pu.debtpositions.activities.activity.AuthorizeOperatorOnDebtPositionTypeActivityImpl;
...
class AuthorizeOperatorOnDebtPositionTypeActivityTest {
  ...
  @BeforeEach
  void init() {
    authorizeOperatorOnDebtPositionTypeActivity = new AuthorizeOperatorOnDebtPositionTypeActivityImpl(debtPositionTypeOrgOperatorsRepositoryMock, debtPositionTypeOrgRepositoryMock);
  }
