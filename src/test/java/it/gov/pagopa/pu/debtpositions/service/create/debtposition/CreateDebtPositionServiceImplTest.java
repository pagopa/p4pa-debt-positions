...
class CreateDebtPositionServiceImplTest {
  ...
  void setUp() {
    createDebtPositionService = new DebtPositionCreationServiceImpl(authorizeOperatorOnDebtPositionTypeServiceMock,
      ...
      debtPositionProcessorServiceMock, organizationServiceMock, debtPositionMapperMock, debtPositionHierarchyStatusAlignerServiceMock);
  }
  ...
  void givenDebtPositionWhenCreateThenOk() {
    ...
    DebtPositionDTO result = createDebtPositionService.createDebtPosition(debtPositionDTO, DebtPositionOrigin.ORDINARY, massive, accessToken, operatorExternalId);
  ...
  void givenDebtPositionOrdinarySilWhenCreateThenOk() {
    ...
    DebtPositionDTO result = createDebtPositionService.createDebtPosition(debtPositionDTO, DebtPositionOrigin.ORDINARY,false, null, null);
  ...
  void givenDebtPositionWithDuplicatesWhenCreateThenThrowConflictErrorException() {
    ...
    ConflictErrorException exception = assertThrows(ConflictErrorException.class, () ->
      createDebtPositionService.createDebtPosition(debtPositionDTO, DebtPositionOrigin.ORDINARY,false, null, null)
    );
