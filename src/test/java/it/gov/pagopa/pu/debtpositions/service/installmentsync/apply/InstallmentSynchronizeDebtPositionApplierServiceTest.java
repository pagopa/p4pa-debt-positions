...
class InstallmentSynchronizeDebtPositionApplierServiceTest {
  ...
  void testMergeDebtPositionImmutableFieldThenException(){
    ...
    assertEquals("[UNMODIFIABLE_FIELD] These fields for debt position with iupd IUPD_ORG are not mutable: [multiDebtor, flagPuPagoPaPayment]", exception.getMessage());
  }
}
