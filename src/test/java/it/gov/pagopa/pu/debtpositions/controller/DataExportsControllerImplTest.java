...
class DataExportsControllerImplTest {
  ...
  void givenWrongPaymentDateTimeInterval_whenGetInstallmentExport_thenThrowException() throws Exception {
    ...
    mockMvc.perform(
      ...
      .andExpect(MockMvcResultMatchers.content().contentType(MediaType.APPLICATION_JSON))
      .andExpect(MockMvcResultMatchers.jsonPath("$.code").value("DEBT_POSITION_BAD_REQUEST"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.message").value("[DATE_FILTER_INTERVAL_EXCEEDED] The date interval between 2025-03-06T17:05:04.685811Z and 2025-11-06T17:05:04.686949700Z cannot exceed 6 months"))
      .andReturn();
