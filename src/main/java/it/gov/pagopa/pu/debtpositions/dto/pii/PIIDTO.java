 ...
 * The related {@link BaseEntityPIIMapper} will use it to build the full representation of the related {@link it.gov.pagopa.pu.debtpositions.model.NoPIIEntity} ({@link FullEntityPIIDTO}.
 */
