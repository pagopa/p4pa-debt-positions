...
@Service
@Slf4j
public class PrimaryOrgInstallmentServiceImpl implements PrimaryOrgInstallmentService {

  private enum CHECK_MODE {EXACTLY_ONE, MOST_RECENT}

  private final InstallmentNoPIIRepository installmentNoPIIRepository;

  public PrimaryOrgInstallmentServiceImpl(InstallmentNoPIIRepository installmentNoPIIRepository) {
  ...
  public Optional<InstallmentNoPII> findPrimaryOrgInstallment(Organization primaryOrg, String noticeNumber){
    ...
    if (!fullInstallmentList.isEmpty()) {
      ...
      if(primaryOrgInstallment.isEmpty()){
        ...
        PrimaryOrgInstallmentServiceImpl.log.info("No valid installment found to associate to receipt [{}/{}]; list of installment/status [{}]", primaryOrg.getOrgFiscalCode() ,noticeNumber, installmentWithStatusList);
      }
