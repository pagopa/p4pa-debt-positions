...
public class DebtPositionServiceImpl implements DebtPositionService {
  ...
  public PagedDebtorUnpaidDebtPositionDTO getPagedDebtorUnpaidDebtPosition(String xFiscalCode, List<Long> organizationIds, Pageable pageable) {
    Page<DebtPosition> pagedPrimaryDebtPositionByFilters = debtPositionRepository.findPagedPrimaryDebtPositionEntityGraphByFilters(xFiscalCode, organizationIds, pageable);
