...
public interface DebtPositionAddInstallmentService {
   ...
   */
  Pair<DebtPositionDTO, String> addInstallment(DebtPositionDTO debtPositionDTO, List<InstallmentDTO> installments2operate, WfExecutionParameters wfExecutionParameters, String accessToken, String operatorExternalUserId);
}
