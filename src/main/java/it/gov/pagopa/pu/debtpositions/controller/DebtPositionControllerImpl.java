...
import it.gov.pagopa.pu.debtpositions.service.installmentsync.InstallmentSynchronizationService;
...
public class DebtPositionControllerImpl implements DebtPositionApi {
  ...
  private final InstallmentSynchronizationService installmentSynchronizationService;

  public DebtPositionControllerImpl(DebtPositionHierarchyStatusAlignerService debtPositionHierarchyStatusAlignerService, CreateDebtPositionService createDebtPositionService, InstallmentSynchronizationService installmentSynchronizationService) {
    ...
    this.installmentSynchronizationService = installmentSynchronizationService;
  }
  ...
  public ResponseEntity<Void> installmentSynchronize(InstallmentSynchronizeDTO installmentSynchronizeDTO, Boolean massive){
    String accessToken = SecurityUtils.getAccessToken();
    String operatorExternalUserId = SecurityUtils.getCurrentUserExternalId();
    String workflowId = installmentSynchronizationService.installmentSynchronize(installmentSynchronizeDTO, massive, accessToken, operatorExternalUserId);
