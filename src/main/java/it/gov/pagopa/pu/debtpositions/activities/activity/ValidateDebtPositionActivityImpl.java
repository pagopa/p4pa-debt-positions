...
import static it.gov.pagopa.pu.debtpositions.activities.util.Utilities.isValidIban;
import static it.gov.pagopa.pu.debtpositions.activities.util.Utilities.isValidPIVA;
...
public class ValidateDebtPositionActivityImpl implements ValidateDebtPositionActivity {
  ...
  public ValidateDebtPositionActivityImpl(TaxonomyRepository taxonomyRepository, DebtPositionTypeOrgRepository debtPositionTypeOrgRepository) {
