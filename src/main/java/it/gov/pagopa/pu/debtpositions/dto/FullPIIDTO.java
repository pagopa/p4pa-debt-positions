 ...
 * If retrieved from the DB and obtained from the related {@link it.gov.pagopa.pu.debtpositions.mapper.BasePIIMapper}, it will store the original {@link NoPIIEntity} entity, inside which it could be possibile to recover {@link PIIDTO}'s identified ({@link NoPIIEntity#getPersonalDataId()})
 * */
