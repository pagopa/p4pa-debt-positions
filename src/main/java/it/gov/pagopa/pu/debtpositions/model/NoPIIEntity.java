 ...
 * The related {@link it.gov.pagopa.pu.debtpositions.mapper.BasePIIMapper} will use the related {@link PIIDTO} to build its full representation ({@link FullPIIDTO}.
 */
