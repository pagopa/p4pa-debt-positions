...
public class TransferMapper {
  ...
  public TransferDTO mapToDto(Transfer transfer) {
    return TransferDTO.builder()
      ...
      .stampType(transfer.getStamp() != null ? transfer.getStamp().getStampType() : null)
      .stampHashDocument(transfer.getStamp() != null ? transfer.getStamp().getStampHashDocument() : null)
      .stampProvincialResidence(transfer.getStamp() != null ? transfer.getStamp().getStampProvincialResidence() : null)
