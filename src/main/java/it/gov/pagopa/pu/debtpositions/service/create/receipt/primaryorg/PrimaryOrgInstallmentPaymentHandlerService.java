...
public class PrimaryOrgInstallmentPaymentHandlerService {
  ...
  public DebtPosition handlePayment(InstallmentNoPII installment, ReceiptWithAdditionalNodeDataDTO receiptDTO, Organization organization){
    ...
    if(InstallmentUtils.ORDINARY_DEBT_POSITION_ORIGINS.contains(dp.getDebtPositionOrigin())){
      ordinaryDPPaymentHandlerService.handlePayment(dp, installment.getInstallmentId(), receiptDTO);
      return dp;
    } else {
