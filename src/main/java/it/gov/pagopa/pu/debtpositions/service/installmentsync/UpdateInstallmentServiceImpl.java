...
public class UpdateInstallmentServiceImpl {
  ...
  public UpdateInstallmentServiceImpl(InstallmentNoPIIRepository installmentNoPIIRepository, DebtPositionRepository debtPositionRepository, DebtPositionMapper debtPositionMapper, UpdateDebtPositionService updateDebtPositionService, CancellationDebtPositionService cancellationDebtPositionService) {
  ...
  public String handleUpdate(DebtPositionDTO debtPositionToSyncDTO, Boolean massive, String accessToken) {
    ...
    debtPositionToSyncDTO.setDebtPositionId(debtPosition.getDebtPositionId());
  ...
  public String handleCancellation(DebtPositionDTO debtPositionToSyncDTO, Boolean massive, String accessToken) {
    ...
    return cancellationDebtPositionService.cancelInstallment(debtPositionDTO, installment.getInstallmentId(), massive, accessToken);
  }
