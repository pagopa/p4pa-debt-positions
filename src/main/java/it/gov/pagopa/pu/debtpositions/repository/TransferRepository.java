...
public interface TransferRepository extends JpaRepository<Transfer, Long> {
  ...
  @ApiResponse(responseCode = "200", content = @Content(schema = @Schema(ref = "CollectionModelTransfer"))) //Schema configuration needed to resolve the DTO generated by SpringDataRest
  @Query
    ("""
      SELECT t
      FROM Transfer t
